...
// Function to Calculate Average of One Student
...
do {
    ...
    choice = Number(readline.question("Enter your choice (1-4): "));
    ...
    switch (choice) {
        ...
        case 4:
            console.log("Thank you for using the Student Record Management System.");
            break;
